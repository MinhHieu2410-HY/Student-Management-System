...
namespace WFEND
{
    public partial class CusMesBox : Form
    {
        private void CusMesBox_Load(object sender, EventArgs e)
        {
        ...
        public CusMesBox(string text, string caption)
        {
            InitializeComponent();
            InitializeItems();
            this.PrimaryColor = primaryColor;
        ...
        public CusMesBox(string text, string caption, MessageBoxButtons buttons)
        {
            InitializeComponent();
            InitializeItems();
            this.PrimaryColor = primaryColor;
        ...
        public CusMesBox(string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon)
        {
            InitializeComponent();
            InitializeItems();
            this.PrimaryColor = primaryColor;
        ...
        public CusMesBox(string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton)
        {
            InitializeComponent();
            InitializeItems();
            this.PrimaryColor = primaryColor;
        ...
        private void InitializeItems()
        {
            ...
            this.labelMessage.MaximumSize = new Size(0, 0);
        ...
        private void SetIcon(MessageBoxIcon icon)
        {
            switch (icon)
            {
                ...
                case MessageBoxIcon.Exclamation://Exclamation
                    this.pictureBoxIcon.Image = Properties.Resources.Cancel;
                    PrimaryColor = Color.FromArgb(255, 140, 0);
                    break;
                case MessageBoxIcon.None: //None
                    this.pictureBoxIcon.Image = Properties.Resources.OK;
